...
if __name__ == "__main__":
  ...
  t_max = 120 # Total observation duration in years
  pt_per_time_unit = 1 # Number of observation points per years
  ...
  use_reentries_path= "examples/electronics/logs/elevators/use/device/reentrances.csv"
  use_occupancy_path= "examples/electronics/logs/elevators/use/device/occupency.csv"
...
#####
  repair_reentries_path= "examples/electronics/logs/elevators/repair/device/reentrances.csv"
  repair_occupancy_path= "examples/electronics/logs/elevators/repair/device/occupency.csv"
